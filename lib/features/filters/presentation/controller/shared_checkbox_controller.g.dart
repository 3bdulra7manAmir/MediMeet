...
part of 'shared_checkbox_controller.dart';
...
final checkboxValuesNotifierProvider = AutoDisposeNotifierProvider<
  ...
  CheckboxValuesNotifier.new,
  name: r'checkboxValuesNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$checkboxValuesNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$CheckboxValuesNotifier
    = AutoDisposeNotifier<Map<CheckboxGroup, Map<String, bool>>>;
